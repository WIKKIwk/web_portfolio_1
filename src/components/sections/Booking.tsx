        ...
        <section className="py-20 bg-primary/5 dark:bg-primary/10">
            <div className="container mx-auto px-4 md:px-6">
                <div className="bg-white dark:bg-neutral-800 rounded-[3rem] p-8 md:p-16 text-center shadow-xl border border-neutral/5 dark:border-white/5 relative overflow-hidden">
                    ...
                    <h2 className="text-3xl md:text-5xl font-heading font-bold text-neutral dark:text-cream mb-6 relative z-10">
                        Sog'lom kelajak sari ilk qadamni qo'ying!
                    </h2>
                    <p className="text-lg md:text-xl text-neutral/60 dark:text-cream/70 max-w-2xl mx-auto mb-10 relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
                        ...
                        <Button size="lg" variant="outline" className="bg-white dark:bg-neutral-900 border-neutral/10 dark:border-white/10 dark:text-cream dark:hover:bg-neutral-800" onClick={() => window.open('tel:+998773183070')}>
