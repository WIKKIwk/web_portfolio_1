...
export function AboutPreview() {
    return (
        <section id="about" className="py-20 bg-secondary/10 dark:bg-neutral-900 relative overflow-hidden">
            {/* Decorative Blob */}
            ...
            <div className="container mx-auto px-4 md:px-6 relative">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1 w-full max-w-lg">
                        <div className="relative">
                            ...
                            <div className="relative bg-white dark:bg-neutral-800 rounded-[3rem] overflow-hidden shadow-2xl aspect-[4/5] border-4 border-white dark:border-neutral-700">
                                ...
                                {/* Badge */}
                                <div className="absolute bottom-6 right-6 bg-white dark:bg-neutral-900 p-4 rounded-2xl shadow-lg animate-bounce-slow">
                                    <p className="font-bold text-neutral dark:text-cream">15+ Years</p>
                                    <p className="text-xs text-neutral/50 dark:text-cream/70">Experience</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 space-y-6">
                        <div className="inline-block px-4 py-1.5 rounded-full bg-white dark:bg-neutral-800 border border-neutral/10 dark:border-white/10 text-sm font-semibold text-neutral/70 dark:text-cream/80 shadow-sm">
                            Bizning Jamoa
                        </div>
                        <h2 className="text-3xl md:text-4xl font-heading font-bold text-neutral dark:text-cream">
                        ...
                        <div className="space-y-3 pt-2">
                            <p className="text-neutral/70 dark:text-cream/70">• Chet elda o'qigan shifokorlar</p>
                            <p className="text-neutral/70 dark:text-cream/70">• Zamonaviy tekshiruv va davolash uskunalari</p>
                            <p className="text-neutral/70 dark:text-cream/70">• 20+ mashg'ulotda ko'zga ko'rinarli natijalar</p>
                        </div>
                        <div className="pt-6">
